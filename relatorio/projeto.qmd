...
```{r}
contar_univariado(acidentes,"periodo" )
```

```{r}
contar_univariado(acidentes,"mes" )
```

```{r}
contar_univariado(acidentes,"dia_semana" )
```

```{r}
contar_univariado(acidentes,"br" )
```

```{r}
contar_univariado(acidentes,"municipio" )
```
